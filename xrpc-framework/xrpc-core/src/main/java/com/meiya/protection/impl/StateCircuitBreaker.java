 ...
 */
@Slf4j
public class StateCircuitBreaker implements CircuitBreaker {
    /**
     * 熔断门限阈值 (错误数)
     */
    ...
    public StateCircuitBreaker(int threshold, int recoveryTime) {
    ...
    public static void main(String[] args) {
        StateCircuitBreaker breaker = new StateCircuitBreaker(3, 10);
